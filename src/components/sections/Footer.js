    ...
    <footer className="relative text-white">
      ...
      <div className="relative z-10">
        <div className="py-16 text-center bg-transparent">
          {/* PERBAIKAN HEADING: Menggunakan &quest; */}
          <h2 className="text-3xl font-bold">Need Help or Want to Talk First&quest;</h2>
          ...
          <div className="flex flex-col items-center justify-center gap-4 mt-8 sm:flex-row">
            ...
            <a href="tel:082144057125" className="inline-block transition-transform cursor-pointer hover:scale-105">
              <Image src="/icons/WA.svg" alt="Hubungi via WhatsApp" width={200} height={50} />
            </a>
            {/* Tombol Kontak Email */}
            <a href="mailto:info@easyticket.id" className="inline-block transition-transform cursor-pointer hover:scale-105">
              <Image src="/icons/Infoeasyticket.svg" alt="Email info@easyticket.id" width={200} height={50} />
            </a>
          </div>
        </div>
        ...
        <div className="container grid grid-cols-1 gap-8 px-8 py-12 mx-auto md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            {/* PERBAIKAN: Menggunakan &mdash; (em dash) dan menghilangkan tanda seru yang tidak ada */}
